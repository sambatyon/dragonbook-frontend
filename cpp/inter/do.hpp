...
inline
void Do::init(std::shared_ptr<Statement> stmt, std::shared_ptr<Expression> expr) {
    stmt_ = stmt;
    expr_ = expr;
...
inline
void Do::gen(const std::uint32_t &b, const std::uint32_t &a) {
    after_ = a;
...
inline
std::shared_ptr<Expression> Do::expr() const {
    return expr_;
}

inline
std::shared_ptr<Statement> Do::stmt() const {
    return stmt_;
}
} // namespace inter
