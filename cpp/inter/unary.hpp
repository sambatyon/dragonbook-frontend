...
inline std::shared_ptr<UnaryOperator> UnaryOperator::create(
    std::shared_ptr<lexer::Token> token,
    std::shared_ptr<Expression> expression
) {
...
inline UnaryOperator::UnaryOperator(std::shared_ptr<lexer::Token> token, std::shared_ptr<Expression> expression)
    : Operator(token, std::shared_ptr<symbols::Type>()), expression_(expression) {
...
inline UnaryOperator::~UnaryOperator() {
}

inline std::shared_ptr<Expression> UnaryOperator::expression() const {
  return expression_;
}
