...
class Logical : public Expression {
 public:
  ...
  virtual void init();
  virtual std::shared_ptr<symbols::Type> check(
...
inline std::shared_ptr<Logical> Logical::create(
    std::shared_ptr<lexer::Token> token,
    std::shared_ptr<Expression> expr1,
    std::shared_ptr<Expression> expr2
) {
...
inline Logical::Logical(
    ...
    : Expression(token, std::shared_ptr<symbols::Type>()), expr1_(expr1), expr2_(expr2) {
}

inline void Logical::init() {
...
inline std::shared_ptr<Expression> Logical::expr1() const {
  return expr1_;
}

inline std::shared_ptr<Expression> Logical::expr2() const {
  return expr2_;
}

inline std::shared_ptr<symbols::Type> Logical::check(
    std::shared_ptr<symbols::Type> left,
    std::shared_ptr<symbols::Type> right
) {
...
inline std::string Logical::to_string() const {
